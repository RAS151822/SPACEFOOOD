...
{
    public partial class MenuAsia : Form
    {
        ...
        {
            openChildForm(new FormTallarines());
        }
            ...
            */
            ...
            if (tamanio == "Small" || tamanio == "Medium" || tamanio == "Big")
            {
                ...
                if (cantidad > 0)//COMPROBAMOS..
                {
                    ...
                    id_producto = "RTD04";
                    nombreproducto = "Rice Three Delicacies";
                    precio = 43;
        ...
        private void TamañoSpagueti_SelectedIndexChanged_1(object sender, EventArgs e)
        {
