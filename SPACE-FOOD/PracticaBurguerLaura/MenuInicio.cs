...
namespace PracticaBurguerLaura
{
    ...
    public partial class MenuInicio : Form
    {
        ...
        private void CarritoAcesoDirecto_Click(object sender, EventArgs e)
        {
            openChildForm(new MenuCarrito());
            HideSubMenu();
        }

        private void MyProfileAccDirect_Click(object sender, EventArgs e)
        {
            openChildForm(new MenuOrders());
        }
    }
